        ...
        <div className="container mx-auto font-poppins mt-20 px-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
                <div className="bg-white text-center border border-[#d6dcee] px-6 pt-16 pb-10 rounded-xl" style={{ boxShadow: "0 0 30px #adb5ca57" }}>
                    ...
                    <p className="mt-10 text-4xl text-[#1554BB] font-semibold leading-7">{activeTab.avgHike}</p>
                ...
                <div className="bg-white  rounded-lg border border-[#d6dcee] col-span-1 md:col-span-2" style={{ boxShadow: "0 0 30px #adb5ca57" }}>
