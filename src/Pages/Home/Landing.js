...
const CourseData = [
    {
        ...
        "rating": "4.7/5",
        "description": "DevOps training emphasizes on integrating development, operations, automation, and continuous delivery collaboration.",
    },
    {
    ...
    },
    {
        ...
        "liveProjects": "5 Live Projects",
        "rating": "4.8/5",
        "description": "AWS training focuses on cloud computing with core services, architecture, security, and best practices.",
    },
    {
        ...
        "liveProjects": "5 Live Projects",
        "rating": "4.8/5",
        "description": "React JS training covers UI building, component architecture, state management, hooks, and modern practices.",
    }
]
const ProgramData = [
    {
        ...
        "rating": "4.7/5",
        "description": "Cloud DevOps Masters Training combines cloud computing and DevOps principles to empower professionals with the knowledge and skills needed to efficiently manage and automate software delivery pipelines in cloud environments.",
    },
    {
        ...
        "liveProjects": "6 Live Projects",
        "rating": "4.8/5",
        "description": "Full Stack Masters Training equips individuals with advanced expertise in both front- end and back - end development, enabling them to architect and build complex, full - fledged web applications with proficiency and versatility.",
    },
    {
        ...
        "liveProjects": "6 Live Projects",
        "rating": "4.9/5",
        "description": "Salesforce Masters Training provides comprehensive knowledge and skills for mastering the Salesforce platform, enabling professionals to design, implement, and optimise Salesforce solutions with expertise, driving business success.",
    },
    {
        ...
        "liveProjects": "6 Live Projects",
        "rating": "4.8/5",
        "description": " Business Data Analyst Masters Training offers a comprehensive way to develop advanced data analysis and interpretation skills, equipping professionals to make informed,data- driven decisions and drive business growth with precision.",
    }
]
...
const batches = [
    {
        ...
        schedule: '(Mon-Fri)',
        time: { date: '25th Sept 2023', day: 'Monday', startTime: '8 AM (IST)', duration: '1hr-1:30hr / Per Session' },
        demoLink: '#',
    },
    {
        title: 'Week Day Batches',
        schedule: '(Mon-Fri)',
        time: { date: '27th Sept 2023', day: 'Wednesday', startTime: '10 AM (IST)', duration: '1hr-1:30hr / Per Session' },
        demoLink: '#',
    },
    {
        title: 'Week Day Batches',
        schedule: '(Mon-Fri)',
        time: { date: '29th Sept 2023', day: 'Friday', startTime: '12 PM (IST)', duration: '1hr-1:30hr / Per Session' },
        demoLink: '#',
    },
];
                ...
                <div className="flex justify-center gap-4">
                    {
                        batches.map((item, index) => {
                            return (
                                <div className="bg-white rounded-lg p-6" style={{ boxShadow: "#E7E7E7 0px 2px 20px" }} >
                    ...
                    <div className="bg-black rounded-lg p-6 w-[280px] mx-auto" style={{ boxShadow: "#E7E7E7 0px 2px 20px" }} >
                        <p className="text-3xl font-bold text-white text-center mt-5 mb-16">Can’t find a batch you were looking for?</p>
                        <WhiteButton name=' Get Free Course Demo ' icon={<VscGraph size={17} />} />
                    </div>
                </div>
            </div>
