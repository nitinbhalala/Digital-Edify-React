...
const WhiteButton = ({ name, icon, theme }) => {
    ...
    return (
        <button
            className={`font-poppins flex justify-center min-w-44 gap-2 lg:gap-3 text-xs lg:text-sm rounded-lg items-center px-2.5 lg:px-4 py-1.5 lg:py-2 font-semibold bg-white
